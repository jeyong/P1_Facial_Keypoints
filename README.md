...
__Notebook 1__ : Loading and Visualizing the Facial Keypoint Data (얼굴 키포인트 데이터 로딩 및 시각화)

__Notebook 2__ : Defining and Training a Convolutional Neural Network (CNN) to Predict Facial Keypoints (얼굴 키포인트 예측을 위한 CNN 정의 및 학습)

__Notebook 3__ : Facial Keypoint Detection Using Haar Cascades and your Trained CNN (Haar Cascades와 학습 CNN을 이용한 얼굴 키포인트 검출)

__Notebook 4__ : Fun Filters and Keypoint Uses (필터와 키포인트 사용)
...
`cv-nd` 연습 코드를 위한 환경 만들었으면 그 환경 사용 가능.
